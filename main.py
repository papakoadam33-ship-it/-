...
def fetch_data():
    ...
    # Χρήση του v3 fixtures που είδαμε ότι είναι το σωστό
    ...
    try:
        ...
        if not predictions:
            # Αν δεν έχει αγώνες ακόμα, αφήνουμε ένα μήνυμα πληροφορίας
            predictions.append("INFO|Το API συνδέθηκε! Περιμένουμε την επόμενη ροή αγώνων...|-, -, -, -")
