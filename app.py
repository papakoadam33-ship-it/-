...
# 1. Κανονική ρύθμιση με το εικονίδιο μπάλας
...
# 2. Επιθετικό HTML Inject για να αλλάξει το σήμα στην αρχική οθόνη του κινητού
st.markdown("""
    <head>
        <link rel="icon" type="image/png" sizes="192x192" href="https://img.icons8.com/emoji/192/soccer-ball-emoji.png">
        <link rel="icon" type="image/png" sizes="512x512" href="https://img.icons8.com/emoji/512/soccer-ball-emoji.png">
        <link rel="apple-touch-icon" sizes="180x180" href="https://img.icons8.com/emoji/180/soccer-ball-emoji.png">
